...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row mb-4" id="hapusform">
            <div class="card" style="padding: 20px">
                <form action="{{ route('hapusguru') }}" method="post">
                    ...
                    <button type="button" class="btn btn-outline-secondary" onclick="return $('#hapusform').hide(500)">
                        Tutup
                    </button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#dataTable').on('click', '.delBtn', function() {
                ...
                var row = $(this).closest('tr');
                var data = table.row(row).data();
                $('#hinputnama').val(data.nama);
                $('#hinputnik').val(data.nik);
                $('#hid').val(data.id);
                if(data.jenis_kelamin === "Laki-laki"){
                    $('#hinputperempuan').prop('checked', false);
                    $('#hinputlaki').prop('checked', true);
                }else{
                    $('#hinputlaki').prop('checked', false);
                    $('#hinputperempuan').prop('checked', true);
                }
                $('#hinputalamat').val(data.alamat);
                $('#hapusform').show(500);
            });
        });
    </script>
